...
5. Next execution target: implement P9-T4 safety interlock engine for physical commands.
...
2. Implement P9-T4 through P9-T12 with verify-then-advance discipline.
