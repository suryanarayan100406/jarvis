...
5. Next execution target: implement P7-T8 incident playbooks for containment and recovery.
...
2. Implement P7-T8 through P7-T12 with verify-then-advance discipline.
