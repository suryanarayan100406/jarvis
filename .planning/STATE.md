...
5. Next execution target: implement P10-T2 benchmark harness runner with reproducible scoring.
...
2. Implement P10-T2 through P10-T12 with verify-then-advance discipline.
