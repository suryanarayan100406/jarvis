...
5. Next execution target: implement P2-T10 CLI commands for submit, status, stop, and replay.
...
2. Implement P2-T10 through P2-T12 with verify-then-advance discipline.
