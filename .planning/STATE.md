...
5. Next execution target: implement P9-T3 simulation harness for motion and actuation plans.
...
2. Implement P9-T3 through P9-T12 with verify-then-advance discipline.
