...
5. Next execution target: implement P7-T9 forensic event export for post-incident analysis.
...
2. Implement P7-T9 through P7-T12 with verify-then-advance discipline.
