...
5. Next execution target: implement P8-T4 visual planner integration with runtime action stages.
...
2. Implement P8-T4 through P8-T12 with verify-then-advance discipline.
