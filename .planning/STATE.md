...
5. Next execution target: implement P10-T7 safety regression gate for every model or policy change.
...
2. Implement P10-T7 through P10-T12 with verify-then-advance discipline.
