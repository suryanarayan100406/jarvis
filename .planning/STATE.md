...
5. Next execution target: implement P5-T3 indexing pipeline with deduplication and version tracking.
...
2. Implement P5-T3 through P5-T4 with verify-then-advance discipline.
